...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden text-sidebar-foreground md:flex md:flex-col md:h-svh"
        data-state={state}
      ...
      >
        <div
          className={cn(
            "flex h-full flex-col transition-[width] duration-200 ease-linear",
            "w-[--sidebar-width]",
            "group-data-[collapsible=offcanvas]:w-0 group-data-[collapsible=offcanvas]:hidden",
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex w-full flex-1 flex-col bg-background min-h-0 overflow-hidden",
